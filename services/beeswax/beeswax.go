...
func (p *Query) Equals(other *Query) bool {
	...
	if p.HadoopUser != other.HadoopUser {
		return false
	}
	return true
}
...
func (p *QueryHandle) Equals(other *QueryHandle) bool {
	...
	if p.LogContext != other.LogContext {
		return false
	}
	return true
}
...
func (p *Results) Equals(other *Results) bool {
	...
	if p.StartRow != other.StartRow {
		return false
	}
	if p.HasMore != other.HasMore {
		return false
	}
	return true
}
...
func (p *ResultsMetadata) Equals(other *ResultsMetadata) bool {
	...
	if p.TableDir != other.TableDir {
		return false
	}
	if p.InTablename != other.InTablename {
		return false
	}
	if p.Delim != other.Delim {
		return false
	}
	return true
}
...
func (p *BeeswaxException) Equals(other *BeeswaxException) bool {
	...
	if !p.Handle.Equals(other.Handle) {
		return false
	}
